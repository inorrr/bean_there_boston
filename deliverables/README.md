# Bean There Boston Submission Deliverables

Published Site: https://bean-there-boston.yinuozhao959.chatgpt.site

GitHub repository: https://github.com/inorrr/bean_there_boston

## Files to Submit

1. Published Site
   - Use the live URL above.

2. Collected Dataset
   - `deliverables/collected_neighborhood_dataset.csv`
   - Neighborhood-level CSV with the processed indicators used by the site.
